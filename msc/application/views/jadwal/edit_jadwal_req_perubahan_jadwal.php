<form action="<?php echo base_url()."jadwal/update_jadwal"?>" method="post">
    <div class="row">
        <div class="col-lg-6">
            ...
            <input type="text" class="form-control" name="id_jadwal" value="<?= $jadwal[0]["id_jadwal"]?>" readonly>
        </div>
        <div class="col-lg-6">
        ...
        <div class="col-lg-6">
            ...
            <?php 
                $waktu_selesai = strtotime($jadwal[0]["jam_slesai"]);
                $waktu_mulai = strtotime($jadwal[0]["jam_mulai"]);
                $selisih_waktu = $waktu_selesai - $waktu_mulai;
                $selisih = floor($selisih_waktu/(60*60));
            ?>
            <input type="time" class="form-control" name="jam_slesai" value="<?php echo $selisih ?>">
        </div>
        <div class="col-lg-6">
			<br>
