...
<html lang="en">
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" method="post" action="<?php echo base_url('index.php/login/aksi_login');?>">
    ...
    <script type="text/javascript" src="<?php echo base_url()?>assets/Dashgum/Theme/assets/js/jquery.backstretch.min.js"></script>
    <script>
        $.backstretch("<?php echo base_url()?>assets/Dashgum/Theme/assets/img/login-bg.jpg", {speed: 500});
    </script>
